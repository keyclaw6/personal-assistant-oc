...
display_platforms = ensure_dict(display, "platforms")
messenger_display = ensure_dict(display_platforms, "messenger")
messenger_display["show_reasoning"] = False
messenger_display["interim_assistant_messages"] = False
messenger_display["tool_progress"] = "off"
messenger_display["long_running_notifications"] = False
messenger_display["busy_ack_detail"] = False

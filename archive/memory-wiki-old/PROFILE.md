...
- Local timezone is Europe/Copenhagen.
- The assistant should be built around OpenClaw.
- The assistant should preserve memory in files and update it continuously.

## Open Questions

- Preferred assistant name.
- Preferred communication channels.
- Which domains should be proactive: calendar, email, coding, finance, health, research, home, or all of the above.
- Which model provider Kristian wants to authenticate first.
